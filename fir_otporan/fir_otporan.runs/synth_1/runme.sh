...
HD_PWD='C:/Users/student/Downloads/otporni/fir_otporan/fir_otporan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_param.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_param.tcl
